...
public class AdjustingClock extends Clock {

    private final ZoneId zone;
    protected Instant instant;

    public AdjustingClock(Instant initialInstant, ZoneId zone) {
        this.instant = initialInstant;
        this.zone = zone;
    }

    public static AdjustingClock ofLocalDateAndLocalTime(LocalDate date, LocalTime time, ZoneId zone) {
        ZonedDateTime zoneDateTime = createZoneDateTime(date, time, zone);
        return new AdjustingClock(zoneDateTime.toInstant(), zone);
    }
    ...
    public Clock withZone(ZoneId zone) {
        ...
        return new AdjustingClock(instant, zone);
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof AdjustingClock other
    ...
    public String toString() {
        return "AdjustingClock[" + instant + "," + zone + "]";
    }
